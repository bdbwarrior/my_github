...
if __name__=="__main__":
    ...
    parser=argparse.ArgumentParser(prog='python main.py',
            description='TOOL FOR ADDRESSBOOK')
    parser.add_argument('-a','--add',nargs=2,type=str,
            metavar=('姓名','电话'),help="添加一个联系人")
    parser.add_argument('-q','--query',nargs='?',type=str,
        const='',metavar=('查询关键字',),help="查询联系人")
    parser.add_argument('-d','--delete',nargs=1,type=int,
        metavar=('联系人信息',),help="删除联系人")
